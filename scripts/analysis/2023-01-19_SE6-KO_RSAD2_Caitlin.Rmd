...
data <- "data/raw/2023-01-19_SE6_KO_RSAD2.xls"

# Name the experiment
experiment <- "SE6-KO_RSAD2_qPCR_Caitlin"
...
summ_data <- summ_data |> 
  filter(sample %in% c("WT", "KO11", "KO30")) #filter down to only the samples we're interested in
